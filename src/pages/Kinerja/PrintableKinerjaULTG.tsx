...
interface PrintableKinerjaULTGProps {
  data: {
...
const PrintableKinerjaULTG = React.forwardRef<
  HTMLDivElement,
  PrintableKinerjaULTGProps
>(({ data, ultgName }, ref) => {
    ...
    <div ref={ref} className="print-container">
      ...
      <div className="print-page">
        <div className="print-header">
          ...
          <h2 className="text-2xl font-semibold text-[#179FB7] text-center mb-8">
            {ultgName}
          </h2>
          <div className="text-center mb-4">
            <span className="text-xl text-gray-600">
              Laporan Kinerja Unit Layanan Transmisi Gardu Induk
            </span>
          </div>
        </div>
        ...
        <div className="print-card">
          ...
          <div className="mt-12 p-6 bg-blue-50 rounded-xl">
            ...
            <div className="grid grid-cols-2 gap-4 text-base text-gray-700">
              <div className="flex items-center gap-3">
                <div className="w-4 h-4 bg-[#155C72] rounded"></div>
                <span>Key Performance Indicators</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-4 h-4 bg-[#D2F8FF] rounded"></div>
      ...
      <div className="print-page">
        <div className="print-card">
          ...
          <div className="space-y-4">
            ...
            {data.performance_indicator.pengendalian_penggunaan_anggaran && (
              <PerformanceItemPrint
                data={
                  data.performance_indicator.pengendalian_penggunaan_anggaran
                }
          ...
          <div className="space-y-6">
            ...
            {data.performance_indicator.maturity_level_transmisi && (
              <HorizontalBarPrint
                ...
                nilai={
                  data.performance_indicator.maturity_level_transmisi.nilai
                }
            ...
            {data.performance_indicator.pendukung_manajemen_sdm && (
              <HorizontalBarPrint
                title={getMainTitle(
                  data.performance_indicator.pendukung_manajemen_sdm.indikator
                )}
                value={parseFloat(
                  data.performance_indicator.pendukung_manajemen_sdm.realisasi
                )}
                target={parseFloat(
                  data.performance_indicator.pendukung_manajemen_sdm.target
                )}
                nilai={data.performance_indicator.pendukung_manajemen_sdm.nilai}
                icon="/IconKinerja/hcr.svg"
              />
            )}
          </div>
...
PrintableKinerjaULTG.displayName = "PrintableKinerjaULTG";

export default PrintableKinerjaULTG;
